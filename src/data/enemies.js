...
export const ENEMIES = {
  ...
  skeleton: {
    ...
    def: 4,
    spd: 6,
    abilities: ['power-strike', 'shadow-strike-monster'],
    element: 'dark',
    xpReward: 15,
    goldReward: 10,
    aiBehavior: 'basic',
  ...
  wraith: {
    ...
    def: 3,
    spd: 11,
    abilities: ['drain-life', 'death-curse', 'shadow-strike-monster'],
    element: 'dark',
    xpReward: 30,
    goldReward: 25,
    aiBehavior: 'caster',
  ...
  'void-stalker': {
    ...
    def: 6,
    spd: 14,
    abilities: ['shadow-strike-monster', 'silence-hex', 'rending-claws'],
    element: 'dark',
    xpReward: 58,
    goldReward: 45,
    aiBehavior: 'aggressive',
  ...
  'phantom-assassin': {
    ...
    def: 5,
    spd: 16,
    abilities: ['shadow-strike-monster', 'venomous-bite', 'smoke-bomb'],
    element: 'dark',
    xpReward: 72,
    goldReward: 58,
    aiBehavior: 'aggressive',
  ...
  'void-knight': {
    ...
    def: 18,
    spd: 8,
    abilities: ['shadow-strike-monster', 'power-strike', 'death-curse'],
    element: 'dark',
    xpReward: 95,
    goldReward: 80,
    aiBehavior: 'aggressive',
